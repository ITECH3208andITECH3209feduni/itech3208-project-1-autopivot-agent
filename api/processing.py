    ...
    try:
        ...
        if job.backdrop_id is not None:
            ...
            if backdrop is not None:
                ...
                # None here is not an error — it means nobody has measured
                # this backdrop's floor yet, and the processor falls back to
                # its own generic guess (APA-138).
                ground_y_ratio = backdrop.ground_y_ratio

        outcome = processor.process(image_bytes, background_bytes, ground_y_ratio=ground_y_ratio)
